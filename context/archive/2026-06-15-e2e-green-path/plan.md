...
- [x] 3.2 Playwright GitHub Actions workflow passes on PR — 4b4a006 (verified PR #21)

#### Manual

- [x] 3.3 Updated §6.3 is sufficient for a new contributor to add an e2e spec — 07aea76
- [x] 3.4 CI job logs show Supabase start, dev server, and both e2e specs passing — 4b4a006 (verified PR #21)
