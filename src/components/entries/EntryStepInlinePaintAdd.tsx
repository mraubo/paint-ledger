...
export function EntryStepInlinePaintAdd({ entryId, stepId, serverError }: EntryStepInlinePaintAddProps) {
  ...
  return (
    <div className="rounded-lg border border-white/10 bg-white/5">
      <button
        ...
        className="flex w-full items-center justify-between gap-2 px-4 py-3 text-left text-sm font-medium text-blue-100/90 transition-colors hover:bg-white/5"
      ...
      >
        ...
        <ChevronDown className={cn("size-4 text-blue-100/60 transition-transform", expanded && "rotate-180")} />
      </button>
